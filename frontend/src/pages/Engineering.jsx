...
const METRICS = [
  {
    ...
    detail:
      "5 auth · 5 projects · 10 milestones · 2 disputes · 1 webhook · 1 upload · 3 reviews",
  },
  {
    value: "21",
    label: "Protected endpoints",
    detail: "requireAuth middleware — JWT cookie verified on every request",
  },
  {
    value: "6",
    label: "Mongoose models",
    detail: "User · Project · Message · Dispute · AuditLog · Review",
  },
  {
    value: "9",
    label: "Milestone states",
    detail:
      "CREATED → FUNDED → IN_PROGRESS → SUBMITTED → APPROVED + 4 exit states",
  },
  {
    value: "9",
    label: "State transitions",
    detail: "All wrapped in MongoDB sessions — atomic by design",
  },
  {
    value: "7",
    label: "Named socket events",
    detail:
      "3 client→server (join, send, typing) · 4 server→client (new, typing, joined, left)",
  },
];
...
export default function Engineering() {
  useEffect(() => {
    document.title = "Engineering — WorkNest";
  }, []);
    ...
    <ShowcaseLayout>
      <div className="mx-auto max-w-6xl px-6 py-16">
        ...
        <p className="mb-12 max-w-2xl text-lg text-gray-600">
          Every metric is derived by counting real route handlers, socket
          events, and models in the source code — not estimated.
        </p>
        ...
        <section className="mb-16">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {METRICS.map((m) => (
              ...
              >
                <div className="mb-1 text-4xl font-extrabold text-indigo-600">
                  {m.value}
                </div>
