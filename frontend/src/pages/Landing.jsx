...
const steps = [
  {
    ...
    detail: "Define scope and milestones upfront",
  },
  {
    icon: "💰",
    label: "Fund a milestone",
    detail: "Escrow funds via Razorpay — held until approved",
  },
  {
    icon: "🚀",
    label: "Freelancer submits",
    detail: "Work delivered, client reviews",
  },
  {
    icon: "✅",
    label: "Approve & auto-payout",
    detail: "Funds release instantly to the freelancer",
  },
];
...
const features = [
  {
    ...
    body: "9-state milestone lifecycle — CREATED → FUNDED → SUBMITTED → APPROVED — with full audit trail.",
  },
  {
    icon: "💬",
    title: "Real-time Chat",
    body: "Socket.io powered per-project rooms with file attachments via Cloudinary.",
  },
  {
    icon: "⚖️",
    title: "Dispute Resolution",
    body: "Either party can raise a dispute; an admin mediates and resolves with a written resolution.",
  },
  {
    icon: "⭐",
    title: "Ratings & Reviews",
    body: "Mutual reviews unlock after project completion — builds trust on both sides.",
  },
];
...
const highlights = [
  ...
  {
    label: "JWT auth",
    sub: "httpOnly cookies, RBAC middleware",
    to: "/architecture",
  },
  {
    label: "MongoDB transactions",
    sub: "Atomic escrow state transitions",
    to: "/architecture",
  },
  {
    label: "Socket.io messaging",
    sub: "Redis-backed, cookie-authed rooms",
    to: "/architecture",
  },
  {
    label: "Razorpay escrow",
    sub: "Orders, HMAC webhooks, payouts",
    to: "/engineering",
  },
  {
    label: "Cloudinary uploads",
    sub: "multer + CloudinaryStorage",
    to: "/case-study",
  },
  {
    label: "Audit logs",
    sub: "Immutable log on every transition",
    to: "/engineering",
  },
  {
    label: "Dispute engine",
    sub: "Admin-mediated with 2 resolution paths",
    to: "/architecture",
  },
];
        ...
        <div className="mx-auto max-w-6xl lg:flex lg:items-center lg:gap-16">
          <div className="flex-1">
            ...
            <p className="mt-5 max-w-xl text-lg text-gray-600">
              Milestone-based escrow for freelance work — clients fund,
              freelancers deliver, funds release on approval. Real-time chat,
              dispute resolution, and auto-payouts built in.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              >
                {loadingRole === "freelancer"
                  ? "Loading…"
                  : "Try live demo as Freelancer"}
              </button>
            </div>

            <p className="mt-3 text-xs text-gray-400">
              No account needed — jumps straight into a live demo.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {techBadges.map((b) => (
              <span
                key={b}
                className="rounded-full border border-gray-200 bg-white px-4 py-1 text-sm font-medium text-gray-700"
              >
                {b}
              </span>
            ))}
      ...
      <footer className="border-t border-gray-100 px-6 py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-2 text-sm text-gray-500 sm:flex-row sm:justify-between">
          ...
          <div className="flex gap-6">
            <a
              href="https://github.com/satyamsipah/WorkNest"
              target="_blank"
